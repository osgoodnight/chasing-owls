...
screen quick_menu():
    ...
    if quick_menu:
        ...
        vpgrid:
            ...
            imagebutton:
                 idle "gui/button/auto_button.png"
                 hover "gui/button/auto_button_hover.png"
                 action Preference("auto-forward", "toggle")

            imagebutton:
                 idle "gui/button/skip_button.png"
                 hover "gui/button/skip_button_hover.png"
                 action Skip()
                 alternate Skip(fast=True, confirm=True)

            imagebutton:
                 idle "gui/button/save_button.png"
                 hover "gui/button/save_button_hover.png"
                 action ShowMenu('save')
            #textbutton _("Q.Save") action QuickSave()
            imagebutton:
                idle "gui/button/load_button.png"
                hover "gui/button/load_button_hover.png"
                action QuickLoad()
            imagebutton:
                 idle "gui/button/history_button.png"
                 hover "gui/button/history_button_hover.png"
                 action ShowMenu('history')
            imagebutton:
                 idle "gui/button/preferences_button.png"
                 hover "gui/button/preferences_button_hover.png"
...
screen navigation():
    ...
    hbox:
        ...
        if main_menu:
            ...
            frame:
                textbutton "{size=30}Start{/size}" action Start()
            ...
            frame:
                textbutton "{size=30}Save{/size}" action ShowMenu("save")
        ...
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            ...
            frame:
                textbutton "{size=30}Help{/size}" action ShowMenu("help")

        if main_menu:

            frame:
                textbutton "{size=30}About{/size}" action ShowMenu("about")

        elif not main_menu:

            frame:
                textbutton "{size=30}Back{/size}" action Return()
    hbox:
        style_prefix "navigation"
        ...
        if _in_replay:
            ...
            frame:
                textbutton _("{size=30}End Replay{/size}") action EndReplay(confirm=True)

        elif not main_menu:

            frame:
                textbutton _("{size=30}Main Menu{/size}") action MainMenu()

style navigation_button is gui_button
style navigation_button_text is gui_menu_button_text
...
screen game_menu(title, scroll=None, yinitial=0.0):
    ...
    if main_menu:
        frame:
            ...
            textbutton "{size=30}Close{/size}" action Return()
...
## Gallery screen menu #########################################################
##
## This is the addition of a multigallery screen.
    ...
    use game_menu(_("Gallery"), scroll="viewport"):
        ...
        vbox:
            ...
            frame:
                xanchor 0.5
                xalign 0.5
                textbutton _("{size=70}BG Gallery{/size}") action ShowMenu("bg")
            frame:
                xanchor 0.5
                xalign 0.5
...
screen about():
    ...
    add "gui/overlay/summary_title.png"
...
screen save():
    ...
    add "gui/overlay/save_title.png"
...
screen load():
    ...
    add "gui/overlay/load_title.png"
...
screen preferences():
    ...
    add "gui/overlay/pref_title.png"
...
screen help():
    ...
    add "gui/overlay/help_title.png"
